...
echo "  1. Configure API keys in /etc/openclaw/env:"
echo "     sudo mkdir -p /etc/openclaw"
echo "     sudo tee /etc/openclaw/env > /dev/null << 'ENVEOF'"
echo "     KIMI_API_KEY=your-key"
echo "     GOOGLE_API_KEY=your-key"
echo "     GEMINI_API_KEY=your-google-key"
echo "     GATEWAY_TOKEN=your-gateway-token"
echo "     ENVEOF"
