...
# === Relax hardening to allow sudo/apt-get ===
# Dedicated VPS + Tailscale. Date: 2026-03-08
ProtectSystem=false
SystemCallFilter=
...
# --- Syscall filtering ---
# Disabled for sudo/apt compatibility on dedicated VPS
# Security enforced by exec-approvals + sudoers instead
SystemCallArchitectures=native

# --- Protect kernel ---
# ProtectKernelTunables/Modules implicitly force NoNewPrivileges=true
ProtectKernelTunables=false
ProtectKernelModules=false
