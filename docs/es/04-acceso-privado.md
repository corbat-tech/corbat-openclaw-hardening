...
!!! warning "El flag --reset reinicia el estado"
    Esto aplica la nueva configuración de tags. Necesitarás re-autenticar si ya estabas conectado.
...
### Perdí acceso por SSH público y Tailscale no funciona
